...
export const siteUrl = "https://childbloom-growth-guide.lovable.app";

export const categories = [
    { slug: "child-health", name: "Child Health", description: "Immunity, illness care, and everyday wellness." },
    { slug: "parenting", name: "Parenting", description: "Practical, judgment-free support for modern families." },
    { slug: "newborn-care", name: "Newborn Care", description: "Gentle routines for the first precious months." },
    { slug: "nutrition", name: "Nutrition", description: "Feeding, growth, and healthy family meals." },
    { slug: "development", name: "Development", description: "Milestones, learning, and brain-healthy habits." },
    { slug: "product-reviews", name: "Product Reviews", description: "Trusted picks for baby gear, toys and family essentials." },
] as const;
...
export const articles: Article[] = [
    ...
    },
    {
        ...
        category: "Nutrition",
        description: "A simple plan for iron-rich first foods, allergen introduction, and baby-led guidance.",
        excerpt: "Iron-rich first foods, allergens, textures, and a simple weekly schedule parents can follow.",
        readTime: "11 min read",
        publishedAt: "2026-05-25",
        tags: ["solids", "nutrition", "feeding"],
        seoTitle: "Starting Solids at 6 Months | ChildBloom",
        metaDescription: "Discover a safe, practical plan for starting solid foods at 6 months, with allergen tips and nutrient-rich choices.",
        hero: "/assets/hero-family.jpg",
        content: `
    ...
    },
    {
        ...
        description: "Track speech and language growth with daily activities that build a toddler's communication skills.",
        excerpt: "What's typical, what's not, and 7 daily moments that quietly grow your toddler's vocabulary.",
        readTime: "7 min read",
        publishedAt: "2026-05-18",
        tags: ["development", "speech", "toddler"],
        seoTitle: "Speech Milestones 12-24 Months | ChildBloom",
        metaDescription: "Find realistic speech milestones for 12- to 24-month-olds and expert tips for supporting early language development.",
        hero: "/assets/hero-family.jpg",
        content: `
    ...
    },
    {
        ...
        description: "A premium review of trusted baby monitors with pros, cons, and Amazon-ready picks for nursery safety.",
        excerpt: "Compare top baby monitors, essential features, and reliable Amazon affiliate picks for newborns.",
        readTime: "9 min read",
        publishedAt: "2026-05-10",
        tags: ["baby monitor", "reviews", "gear"],
        seoTitle: "Best Baby Monitors 2026 | ChildBloom Reviews",
        metaDescription: "Explore the best baby monitors of 2026 with ratings, pros and cons, and trusted product recommendations for new parents.",
        hero: "/assets/hero-family.jpg",
