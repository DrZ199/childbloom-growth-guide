  ...
  head: () => ({
    meta: [
      { title: "Newborn Care Guide: Complete 0-3 Month Handbook | ChildBloom" },
      {
        name: "description",
        content:
          "Complete newborn care guide for first-time parents: feeding, sleep, diapering, bathing, health concerns, and when to call the doctor. Evidence-based advice from pediatric experts.",
      },
      {
        property: "og:title",
        content: "Newborn Care Guide: Complete 0-3 Month Handbook | ChildBloom",
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: "https://childbloom.site/articles/newborn-care-guide",
            },
          ],
        }),
      },
        ...
        <article className="space-y-8 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
          ...
          >
            ...
            <ol className="space-y-2">
              <li>
                <a href="#understanding-newborn" className="text-primary hover:underline">
              ...
              <li>
                <a href="#sleep-patterns" className="text-primary hover:underline">
              ...
              <li>
                <a href="#bathing" className="text-primary hover:underline">
                  Bathing & Skin Care
                </a>
              </li>
              <li>
                <a href="#cord-care" className="text-primary hover:underline">
                  Umbilical Cord & Circumcision Care
                </a>
              </li>
              <li>
                <a href="#common-concerns" className="text-primary hover:underline">
                  Common Concerns: Jaundice, Reflux, Colic
                </a>
              </li>
              <li>
                <a href="#when-to-call" className="text-primary hover:underline">
          ...
          >
            ...
            <p>
              The first three months—often called the "fourth trimester"—are a time of incredible
              adjustment for both baby and parents. Your newborn is transitioning from the womb's
              constant environment to a world of new sensations, and their needs are simple but
              constant.
            </p>
            <p>
              <strong>Newborns communicate through cues:</strong> rooting (turning head toward
              breast), smacking lips, sucking motions = hunger; yawning, rubbing eyes, looking away
              = tired; fussing, squirming = discomfort or overstimulation.
            </p>
            <div className="rounded-2xl border border-border bg-muted p-5">
              <h3 className="font-semibold text-lg mb-2">Key Principle: Responsive Care</h3>
              <p className="text-sm text-muted-foreground">
                You cannot spoil a newborn. Responding promptly to cries builds trust, regulates
                their nervous system, and actually reduces crying over time. The "cry it out" method
                is not appropriate for babies under 4–6 months.
              </p>
            </div>
            <h3 className="text-xl font-semibold">What's Normal in the First Weeks</h3>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Breathing:</strong> Irregular patterns, periodic pauses up to 10 seconds
                (periodic breathing)
              </li>
              <li>
                <strong>Skin:</strong> Peeling, milia (tiny white bumps), stork bites (red patches
                on neck/eyelids), newborn acne
              </li>
              <li>
                <strong>Reflexes:</strong> Moro (startle), rooting, sucking, grasp, stepping — all
                fade by 3–6 months
              </li>
              <li>
                <strong>Weight:</strong> Up to 10% loss in first week, back to birth weight by 2
                weeks
              </li>
              <li>
                <strong>Vision:</strong> Best at 8–12 inches (your face during feeding); prefers
                high contrast
              </li>
            </ul>
          </section>
          ...
          <section id="feeding" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <p>
              The AAP recommends exclusive breastfeeding for ~6 months, then continued breastfeeding
              with solids for 2+ years.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Frequency:</strong> 8–12 times per 24 hours (every 2–3 hours), on demand
              </li>
              <li>
                <strong>Duration:</strong> 10–20 minutes per side; let baby set the pace
              </li>
              <li>
                <strong>Latch:</strong> Wide mouth, flanged lips, chin touching breast, more areola
                visible above than below
              </li>
              <li>
                <strong>Supplements:</strong> Vitamin D (400 IU/day) starting day 1; Iron at 4
                months if exclusively breastfed
              </li>
              <li>
                <strong>Mom's nutrition:</strong> Extra 300–500 kcal/day; stay hydrated; continue
                prenatal vitamin
              </li>
            </ul>
            ...
            <p>
              Choose iron-fortified formula. All FDA-regulated formulas meet nutritional
              standards—no brand is "best."
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Types:</strong> Cow's milk-based (standard), gentle/partially hydrolyzed,
                soy, hypoallergenic
              </li>
              <li>
                <strong>Preparation:</strong> Follow label exactly; use safe water; don't dilute or
                concentrate
              </li>
              <li>
                <strong>Amount:</strong> ~2.5 oz per pound of body weight per day (e.g., 10 lb baby
                = 25 oz/day)
              </li>
              <li>
                <strong>Paced bottle feeding:</strong> Hold bottle horizontal, let baby control
                flow—prevents overfeeding
              </li>
            </ul>

            <h3 className="text-xl font-semibold">Combination Feeding</h3>
            <p>
              Many families combine breast milk and formula. Any breast milk is beneficial. Work
              with a lactation consultant to protect supply if that's your goal.
            </p>
          ...
          >
            ...
            <p>
              Newborns spend 50% of sleep time in active REM cycles (vs. 20% for adults). They wake
              frequently—this is protective, not a problem.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Total sleep:</strong> 14–17 hours/24 hours (highly variable)
              </li>
              <li>
                <strong>Wake windows:</strong> 45–90 minutes max (including feeding time)
              </li>
              <li>
                <strong>Day/night confusion:</strong> Common first 6–8 weeks; expose to daylight,
                keep nights dark/quiet
              </li>
              <li>
                <strong>Active sleep:</strong> Grunting, twitching, smiling, brief cries—baby is
                still asleep
              </li>
            </ul>
            ...
            <div className="rounded-2xl border border-red-200 bg-red-50 p-5">
              ...
              <ul className="list-disc space-y-2 pl-6 text-sm text-red-700">
                <li>
                  <strong>Back to sleep</strong> for every sleep—naps and nights
                </li>
                <li>
                  <strong>Firm, flat surface</strong> in safety-approved crib/bassinet (no inclined
                  sleepers)
                </li>
                <li>
                ...
                <li>
                  <strong>No smoke exposure</strong> — major SIDS risk factor
                </li>
              </ul>
            </div>
          ...
          <section id="diapering" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Frequency:</strong> 8–12 diapers/day (wet + dirty)
              </li>
              <li>
                <strong>Wet diapers:</strong> 6+ heavy wet diapers/day = good hydration
              </li>
              <li>
                <strong>Stool progression:</strong> Meconium (black/tarry) → transitional (green) →
                breastfed (yellow/seedy) or formula (tan/pasty)
              </li>
              <li>
                <strong>Wiping:</strong> Front to back for girls; clean all folds for boys
              </li>
              <li>
                <strong>Diaper cream:</strong> Zinc oxide at every change for prevention; thick
                layer for rash
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                If rash persists &gt;3 days, has blisters/pus, or spreads: call doctor (may be
                yeast)
              </li>
            </ul>
          </section>
          ...
          <section id="bathing" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Frequency:</strong> 2–3 times/week (sponge baths until cord falls off)
              </li>
              <li>
                <strong>Water temp:</strong> 98–100°F (37–38°C) — test with wrist/elbow
              </li>
              <li>
                <strong>Soap:</strong> Mild, fragrance-free, or water only for first month
              </li>
              <li>
                <strong>Cradle cap:</strong> Gentle brushing with soft brush + mineral oil before
                bath
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Moisturize:</strong> Fragrance-free cream/ointment after bath (locks in
                moisture)
              </li>
              <li>
                <strong>Laundry:</strong> Free & clear detergent; no fabric softener/dryer sheets
              </li>
              <li>
                <strong>Sun protection:</strong> Shade, clothing, hat — no sunscreen &lt;6 months
              </li>
              <li>
                <strong>Nail care:</strong> File or clip while baby sleeps; mittens only for first
                few weeks
              </li>
            </ul>
          </section>
          ...
          <section id="cord-care" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Falls off:</strong> Typically 1–3 weeks
              </li>
              <li>
                <strong>Care:</strong> Keep clean and dry; fold diaper below stump
              </li>
              <li>
                <strong>No alcohol needed</strong> — current guidelines: dry care only
              </li>
              <li>
                <strong>Call doctor if:</strong> Redness spreading, foul odor, pus, bleeding &gt;
                few drops
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Healing:</strong> 7–10 days; petroleum jelly on gauze with each diaper
                change
              </li>
              <li>
                <strong>Normal:</strong> Yellowish film (granulation tissue), slight swelling
              </li>
              <li>
                <strong>Call doctor if:</strong> Persistent bleeding, increasing redness, fever, no
                wet diaper 8+ hours
              </li>
            </ul>
          </section>
          ...
          >
            ...
            <p>
              Yellowing of skin/eyes from bilirubin buildup. Affects 60% of full-term, 80% of
              preterm babies.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Physiologic jaundice:</strong> Peaks day 3–5, resolves by 2 weeks
              </li>
              <li>
                <strong>Breastfeeding jaundice:</strong> From inadequate intake — feed more
                frequently
              </li>
              <li>
                <strong>Call doctor if:</strong> Jaundice in first 24 hours, spreading to arms/legs,
                baby lethargic/poor feeding
              </li>
            </ul>

            <h3 className="text-xl font-semibold">Reflux (Spit-Up)</h3>
            <p>
              Effortless spit-up is normal (immature lower esophageal sphincter). Peaks 4 months,
              resolves by 12–18 months.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Happy spitter:</strong> Gains weight, not distressed — no treatment needed
              </li>
              <li>
                <strong>Management:</strong> Smaller, frequent feeds; upright 20–30 min after
                eating; burp mid-feed
              </li>
              <li>
                <strong>Call doctor if:</strong> Forceful projectile vomiting, poor weight gain,
                blood/green in spit-up, respiratory symptoms
              </li>
            </ul>

            <h3 className="text-xl font-semibold">Colic</h3>
            <p>
              Crying &gt;3 hours/day, &gt;3 days/week, &gt;3 weeks in otherwise healthy baby. Peaks
              6 weeks, resolves by 3–4 months.
            </p>
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Not your fault</strong> — not caused by parenting, diet (usually), or gas
              </li>
              <li>
                <strong>Soothing:</strong> 5 S's (swaddle, side/stomach hold, shush, swing, suck);
                white noise; walk outside
              </li>
              <li>
                <strong>Probiotics (L. reuteri):</strong> Some evidence for breastfed babies
              </li>
              <li>
                <strong>Call doctor if:</strong> Crying pattern changes, fever, vomiting, diarrhea,
                poor weight gain
              </li>
            </ul>
          </section>
          ...
          <section id="when-to-call" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <div className="rounded-2xl border border-red-200 bg-red-50 p-5">
              ...
              <ul className="list-disc space-y-2 pl-6 text-sm text-red-700">
                ...
                <li>Seizure</li>
                <li>
                  Signs of dehydration: no wet diaper 8+ hours, dry mouth, sunken fontanelle, no
                  tears
                </li>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-border/50">
                    ...
                    <td className="p-3">
                      <strong>Social smile</strong>; coos; turns to sound
                    </td>
          ...
          <section id="faq" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <dl className="space-y-6">
              <div>
                ...
                <dd className="mt-2">
                  2–3 times per week is plenty. Daily baths can dry out delicate skin. Sponge baths
                  until the umbilical cord falls off (1–3 weeks), then tub baths are fine.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                ...
                <dd className="mt-2">
                  Fresh air walks are fine immediately. Avoid crowded indoor spaces (malls,
                  airplanes) for the first 6–8 weeks, especially during cold/flu season. Anyone
                  holding baby should wash hands first.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                ...
                <dd className="mt-2">
                  Yes! Hiccups are very common in newborns and don't bother them. They're caused by
                  diaphragm spasms from an immature nervous system. No treatment needed—they'll
                  outgrow it.
                </dd>
              </div>
              <div>
                ...
                <dd className="mt-2">
                  The posterior (back) fontanelle closes by 2–3 months. The anterior (top)
                  fontanelle closes between 9–18 months. It should feel soft and flat—sunken =
                  dehydration, bulging = emergency.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                ...
                <dd className="mt-2">
                  6+ heavy wet diapers/day after day 5, regular bowel movements, content after
                  feeds, gaining weight appropriately (pediatrician tracks at visits). Weight checks
              ...
              <div>
                ...
                <dd className="mt-2">
                  Yes, for the first 2 weeks (until back to birth weight), wake every 3 hours day/4
                  hours night if not waking on their own. After that, let them wake naturally unless
              ...
              <div>
                ...
                <dd className="mt-2">
                  If it wipes off easily, it's likely milk residue. If it doesn't wipe off and looks
                  like cottage cheese, it could be thrush (yeast)—call your pediatrician for
