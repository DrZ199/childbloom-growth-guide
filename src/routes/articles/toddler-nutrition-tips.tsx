        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <header className="mb-10">
            ...
            <p className="text-xl text-gray-600 mb-6 leading-relaxed">
              Expert toddler nutrition guide: portion sizes, food groups, picky eating strategies,
              meal planning, and nutrient needs for ages 1-3.
            </p>
              ...
              <div className="prose prose-lg prose-pink max-w-none">
                <div className="bg-pink-50 border-l-4 border-pink-500 p-6 rounded-r-lg mb-8">
                  <p className="text-pink-900 font-medium text-lg">
                    Toddler nutrition is about building healthy habits for life. Between ages 1-3,
                    growth slows but brain development accelerates. This guide covers everything you
                    need to nourish your growing toddler.
                  </p>
                </div>
                ...
                <section id="nutrient-needs" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Toddlers need a variety of nutrients to support rapid brain development, bone
                    growth, and emerging independence. Here are the key nutrients and daily
                    requirements:
                  </p>
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">
                            Milk, yogurt, cheese, fortified plant milks, leafy greens
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">
                            Red meat, fortified cereals, beans, spinach, eggs
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                        ...
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">
                            Avocado, nut butters, olive oil, fatty fish, full-fat dairy
                          </td>
                        </tr>
                        <tr>
                  ...
                  <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-6">
                    ...
                    <p className="text-gray-700">
                      The brain reaches 80% of adult size by age 3. DHA, iron, zinc, choline, and
                      healthy fats are critical. Include fatty fish (salmon, sardines) 1-2 times per
                      week, eggs, and fortified foods.
                    </p>
                  </div>
                </section>
                ...
                <section id="portion-sizes" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Toddler portions are much smaller than adult portions. A good rule of thumb: 1
                    tablespoon per year of age for each food group, or 1/4 to 1/2 of an adult
                    portion.
                  </p>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">
                    ...
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">
                            1/2 slice bread, 1/4 cup cooked rice/pasta, 1/2 cup cereal
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                        ...
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">2-3</td>
                          <td className="py-2 px-4">
                            1/4 cup fresh/frozen, 1/4 medium whole fruit
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">2-3</td>
                          <td className="py-2 px-4">
                            1 oz meat/fish, 1 egg, 1/4 cup beans, 1 tbsp nut butter
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                        ...
                        <tr>
                          ...
                          <td className="py-2 px-4">
                            1 tsp oil/butter, 1/4 avocado, 1 tbsp nut butter
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <p className="text-gray-700 mb-4">
                    Toddlers are excellent at self-regulating. Some days they eat a lot; other days,
                    very little. This is normal. Your job: provide healthy options at regular times.
                ...
                <section id="food-groups" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Aim for variety within each food group over the course of a week, not
                    necessarily every day. Here's how to build balanced meals:
                  </p>
                  <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <section id="picky-eating" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Picky eating peaks at age 2-3 and is developmentally normal. It's about control,
                    not food. These evidence-based strategies reduce mealtime battles:
                  </p>
                  <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                      <li>
                        <strong>Parent decides:</strong> What, when, where food is served
                      </li>
                      <li>
                        <strong>Child decides:</strong> Whether to eat, how much to eat
                      </li>
                  ...
                  <ol className="list-decimal pl-6 space-y-3 text-gray-700 mb-4">
                    <li>
                      <strong>Eat together</strong>—family meals model healthy eating
                    </li>
                    <li>
                      <strong>Offer new foods with familiar ones</strong>—don't overwhelm
                    </li>
                    <li>
                      <strong>Make food fun</strong>—cookie cutters, dips, colorful plates
                    </li>
                    <li>
                      <strong>Involve them</strong>—grocery shopping, washing veggies, stirring
                    </li>
                    <li>
                      <strong>Repeated exposure</strong>—it takes 10-15 tries to accept new food
                    </li>
                    <li>
                      <strong>Serve small portions</strong>—less overwhelming, can ask for more
                    </li>
                    <li>
                      <strong>Limit snacking</strong>—hungry toddlers eat better at meals
                    </li>
                    <li>
                      <strong>Don't label foods "good/bad"</strong>—all foods fit
                    </li>
                  </ol>
                  <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                ...
                <section id="meal-planning" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    These sample days show how to distribute food groups across meals and snacks.
                    Adjust portions for your child's age and appetite.
                  </p>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Sample Day (Age 2)</h3>
                    <ul className="space-y-3 text-gray-700">
                      <li>
                        <strong>Breakfast:</strong> Oatmeal with mashed banana, ground flaxseed,
                        whole milk + scrambled egg
                      </li>
                      <li>
                        <strong>Snack:</strong> Apple slices with peanut butter (thinly spread)
                      </li>
                      <li>
                        <strong>Lunch:</strong> Whole wheat quesadilla with cheese, black beans,
                        avocado + steamed broccoli
                      </li>
                      <li>
                        <strong>Snack:</strong> Greek yogurt with berries + whole grain crackers
                      </li>
                      <li>
                        <strong>Dinner:</strong> Baked salmon, roasted sweet potato, green beans +
                        quinoa
                      </li>
                      <li>
                        <strong>Bedtime snack (if needed):</strong> Small cup of milk
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="space-y-3 text-gray-700">
                      <li>
                        <strong>Breakfast:</strong> Whole grain toast with avocado, sliced
                        hard-boiled egg, orange slices
                      </li>
                      <li>
                        <strong>Snack:</strong> Hummus with cucumber sticks, bell pepper strips
                      </li>
                      <li>
                        <strong>Lunch:</strong> Turkey & cheese roll-ups, cherry tomatoes, grapes,
                        popcorn
                      </li>
                      <li>
                        <strong>Snack:</strong> Cottage cheese with pineapple + rice cakes
                      </li>
                      <li>
                        <strong>Dinner:</strong> Chicken stir-fry with mixed vegetables, brown rice
                      </li>
                      <li>
                        <strong>Bedtime snack (if needed):</strong> Small banana with peanut butter
                      </li>
                    </ul>
                  </div>
                </section>
                ...
                <section id="snacks" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Toddlers need 2-3 snacks daily to meet nutrient needs. Think of snacks as
                    "mini-meals" with at least 2 food groups:
                  </p>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                ...
                <section id="drinks" className="mb-12 scroll-mt-24">
                    ...
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        ...
                        <tr className="border-b border-gray-100">
                          ...
                          <td className="py-2 px-4">
                            Only fortified soy milk nutritionally equivalent
                          </td>
                        </tr>
                        <tr className="border-b border-gray-100">
                          <td className="py-2 px-4 font-medium">Toddler Formulas</td>
                          <td className="py-2 px-4">
                            Unnecessary for most; marketing, not nutrition
                          </td>
                        </tr>
                        <tr>
                  ...
                  <p className="text-gray-700 mb-4">
                    AAP recommends transitioning from bottle to cup by 18 months. Use open cups or
                    straw cups (not sippy cups with valves) to promote oral motor development.
                  </p>
                </section>
                ...
                <section id="supplements" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Most toddlers eating a varied diet don't need multivitamins. However, some
                  ...
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                      <li>
                        <strong>Vitamin D:</strong> 400-600 IU daily (especially if limited sun
                        exposure)
                      </li>
                      <li>
                        <strong>Iron:</strong> Only if pediatrician confirms deficiency (screen at
                        12 months)
                      </li>
                      <li>
                        <strong>DHA/Omega-3:</strong> If not eating fatty fish 1-2x/week
                      </li>
                    </ul>
                  </div>
                  <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  ...
                  <p className="text-gray-700 mb-4">
                    Always choose third-party tested supplements (NSF, USP verified) and discuss
                ...
                <section id="faq" className="mb-12 scroll-mt-24">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        No. Toddlers often front-load calories at breakfast and lunch. Dinner is
                        frequently the smallest meal. Look at intake over the week, not per meal. If
                        growth is on track, they're getting enough.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        16-24oz per day maximum. More than this can cause iron deficiency (milk
                        blocks iron absorption) and fill them up so they don't eat solid foods.
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        It's fine to add veggies to sauces, smoothies, baked goods—but also serve
                        them visibly. Kids need to see, touch, and learn about vegetables to accept
                        them long-term. Hiding alone doesn't teach eating habits.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        Carbs are a toddler's preferred fuel source—this is normal! Keep offering
                        protein and veggies without pressure. Serve them alongside preferred carbs.
                        Model eating them yourself. This phase passes.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        Avoid using food as reward or punishment ("eat broccoli to get dessert").
                        This teaches that healthy foods are "bad" and treats are "good." Instead,
                        serve dessert with the meal occasionally, or offer it regardless of what was
                        eaten.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        AAP recommends whole milk until age 2 for brain development. After 2, you
                        can switch to 2% or continue whole milk. Skim milk is not recommended before
                        age 5. Discuss with your pediatrician based on growth and family history.
                      </p>
                    </div>
                  </div>
                </section>
