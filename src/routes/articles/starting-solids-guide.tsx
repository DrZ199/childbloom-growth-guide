        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <header className="mb-10">
            ...
            <p className="text-xl text-gray-600 mb-6 leading-relaxed">
              Complete guide to starting solids: readiness signs, first foods, baby-led weaning vs
              purees, allergens, schedules, and common mistakes to avoid.
            </p>
              ...
              <div className="prose prose-lg prose-pink max-w-none">
                <div className="bg-pink-50 border-l-4 border-pink-500 p-6 rounded-r-lg mb-8">
                  <p className="text-pink-900 font-medium text-lg">
                    Starting solids is an exciting milestone! Around 6 months, your baby needs
                    nutrients (especially iron) that breast milk or formula alone can't provide.
                ...
                <section id="readiness-signs" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    The AAP and WHO recommend starting solids around 6 months, but age alone isn't
                    enough. Your baby must show developmental readiness signs. Starting too early
                    increases choking risk and doesn't help sleep.
                  </p>
                  <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                      <li>
                        <strong>Good head control</strong>—holds head steady, upright
                      </li>
                      <li>
                        <strong>Sits with minimal support</strong>—doesn't slump in high chair
                      </li>
                      <li>
                        <strong>Lost tongue-thrust reflex</strong>—doesn't automatically push food
                        out
                      </li>
                      <li>
                        <strong>Shows interest in food</strong>—watches you eat, reaches for food
                      </li>
                      <li>
                        <strong>Can move food to back of mouth</strong>—coordination to swallow
                      </li>
                      <li>
                        <strong>Doubled birth weight</strong>—typically around 13+ lbs
                      </li>
                    </ul>
                  </div>
                ...
                <section id="first-foods" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Iron-rich foods should be the priority. Breastfed babies especially need iron
                    from solids around 6 months. There's no single "perfect" first food—variety is
                    key.
                  </p>
                ...
                <section id="methods" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Both approaches are valid. Many families use a combination (combo feeding).
                  ...
                  <p className="text-gray-700 mb-4">
                    Offer iron-rich purees (meat, beans, fortified cereal) on a preloaded spoon for
                    baby to self-feed, plus soft finger foods. Best of both worlds!
                  </p>
                </section>
                ...
                <section id="allergen-introduction" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Early, regular introduction of allergens (starting around 6 months) reduces food
                    allergy risk. The LEAP study showed 80% reduction in peanut allergy with early
                    introduction.
                  </p>
                  ...
                  <ol className="list-decimal pl-6 space-y-3 text-gray-700 mb-4">
                    <li>
                      <strong>One at a time:</strong> Introduce one new allergen every 2-3 days
                    </li>
                    <li>
                      <strong>Start small:</strong> 1/4 teaspoon mixed into tolerated food
                    </li>
                    <li>
                      <strong>Morning/early afternoon:</strong> So you can monitor for reactions
                    </li>
                    <li>
                      <strong>Watch for 2 hours:</strong> Hives, swelling, vomiting, breathing
                      changes
                    </li>
                    <li>
                      <strong>If tolerated:</strong> Offer regularly (2-3x/week) to maintain
                      tolerance
                    </li>
                    <li>
                      <strong>If reaction:</strong> Stop, contact pediatrician, call 911 for severe
                      symptoms
                    </li>
                  </ol>
                  <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-3">
                  ...
                  <p className="text-gray-700 mb-4">
                    If your baby has severe eczema or existing food allergy, consult your
                    pediatrician before introducing allergens. They may recommend allergy testing or
                ...
                <section id="feeding-schedule" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    Solids complement, not replace, milk feeds.
                  </p>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                ...
                <section id="foods-to-avoid" className="mb-12 scroll-mt-24">
                  ...
                  <div className="bg-red-50 border border-red-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                      <li>
                        <strong>Honey:</strong> Botulism risk (spores survive in honey)
                      </li>
                      <li>
                        <strong>Cow's milk as drink:</strong> Blocks iron, kidneys can't handle
                        protein load
                      </li>
                      <li>
                        <strong>Unpasteurized foods:</strong> Raw milk, cheese, juice (bacteria
                        risk)
                      </li>
                      <li>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-6">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                      <li>
                        <strong>Added salt:</strong> Baby kidneys can't process excess sodium
                      </li>
                      <li>
                        <strong>Added sugar:</strong> No nutritional need, shapes preferences
                      </li>
                      <li>
                        <strong>Choking hazards:</strong> Whole nuts, grapes, hot dogs, popcorn, raw
                        carrots, apples
                      </li>
                      <li>
                        <strong>Rice cereal daily:</strong> Arsenic concern—vary grains
                      </li>
                      <li>
                        <strong>Juice:</strong> Not recommended under 1; max 4oz after 1
                      </li>
                    </ul>
                  </div>
                </section>
                ...
                <section id="choking-vs-gagging" className="mb-12 scroll-mt-24">
                  ...
                  <p className="text-gray-700 mb-4">
                    Gagging is normal and protective. Choking is an emergency. Knowing the
                    difference keeps you calm and your baby safe.
                  </p>
                  <div className="bg-white border border-gray-200 p-6 rounded-lg mb-6">
                    <table className="w-full border-collapse">
                      <thead>
                  ...
                  <div className="bg-red-50 border border-red-200 p-6 rounded-lg mb-6">
                    ...
                    <p className="text-gray-700 mt-3">
                      <strong>Take an infant CPR class before starting solids.</strong>
                    </p>
                  </div>
                </section>
                ...
                <section id="common-mistakes" className="mb-12 scroll-mt-24">
                  ...
                  <ol className="list-decimal pl-6 space-y-4 text-gray-700 mb-4">
                    <li>
                      <strong>Starting too early:</strong> Before 4 months or without readiness
                      signs
                    </li>
                    <li>
                      <strong>Only offering sweet foods:</strong> Baby prefers sweet, but needs
                      variety
                    </li>
                    <li>
                      <strong>Giving up on rejected foods:</strong> Takes 10-15 exposures to accept
                    </li>
                    <li>
                      <strong>Adding cereal to bottle:</strong> Choking risk, doesn't help sleep
                    </li>
                    <li>
                      <strong>Forcing "one more bite":</strong> Undermines self-regulation
                    </li>
                    <li>
                      <strong>Delaying allergens:</strong> Increases allergy risk
                    </li>
                    <li>
                      <strong>Using food as reward:</strong> Creates unhealthy relationship
                    </li>
                    <li>
                      <strong>Not including baby in family meals:</strong> Social learning is
                      powerful
                    </li>
                    <li>
                      <strong>Worrying about mess:</strong> Sensory exploration is part of learning
                    </li>
                    <li>
                      <strong>Comparing to other babies:</strong> Every baby progresses differently
                    </li>
                  </ol>
                </section>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        AAP recommends around 6 months. Some babies show readiness at 4-5 months,
                        but never before 4 months. If your baby seems ready early, consult your
                        pediatrician. Most do well waiting until 6 months.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        No. Rice cereal was traditional but isn't necessary. It's low in nutrition
                        and has arsenic concerns. Iron-fortified oat, barley, or multigrain cereals
                        are better, or skip cereal entirely and start with iron-rich pureed meats,
                        beans, or vegetables.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        Mild: hives, rash around mouth, mild vomiting, diarrhea. Severe
                        (anaphylaxis): swelling of lips/tongue/throat, difficulty breathing,
                        wheezing, pale/blue skin, loss of consciousness. Severe = call 911
                        immediately.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        Yes! Gagging is a protective reflex that prevents choking. The gag reflex is
                        very forward in babies and moves back as they mature. Stay calm, don't
                        intervene unless they're choking (silent, blue, can't breathe).
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        6-12 months: 2-4oz/day with meals in an open cup. Breast milk/formula
                        provides all hydration needed. Water is for practice and preventing
                        constipation. Don't replace milk feeds with water.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        Yes! Babies don't need teeth for BLW. They use their gums (which are very
                        strong) to mash soft foods. Offer foods that pass the "squish test"—you can
                        squish between thumb and forefinger.
                      </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      ...
                      <p className="text-gray-700">
                        It's normal for babies to take weeks or months to get interested. Keep
                        offering without pressure. Eat together, let them explore food, try
                        different textures. If no interest by 8-9 months, consult pediatrician.
                      </p>
                    </div>
                  </div>
                </section>
