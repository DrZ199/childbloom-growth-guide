  ...
  head: () => ({
    meta: [
      { title: "Child Nutrition Guide: Feeding Babies, Toddlers & Kids | ChildBloom" },
      {
        name: "description",
        content:
          "Complete child nutrition guide by age: breastfeeding, formula, starting solids, picky eating, vitamins, and healthy habits. Evidence-based feeding advice for every stage.",
      },
      {
        property: "og:title",
        content: "Child Nutrition Guide: Feeding Babies, Toddlers & Kids | ChildBloom",
      },
      {
        ...
        <article className="space-y-8 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              15 min read • Published January 16, 2026 • Medically reviewed by Dr. Emma Lane, MD
            </p>
          </div>
          ...
          >
            ...
            <ol className="space-y-2">
              <li>
                <a href="#nutrition-basics" className="text-primary hover:underline">
                  Nutrition Basics by Age
                </a>
              </li>
              <li>
                <a href="#0-6-months" className="text-primary hover:underline">
                  0–6 Months: Breast Milk & Formula
                </a>
              </li>
              <li>
                <a href="#6-12-months" className="text-primary hover:underline">
                  6–12 Months: Starting Solids
                </a>
              </li>
              <li>
                <a href="#1-3-years" className="text-primary hover:underline">
                  1–3 Years: Toddler Nutrition
                </a>
              </li>
              <li>
                <a href="#4-8-years" className="text-primary hover:underline">
                  4–8 Years: School-Age Nutrition
                </a>
              </li>
              <li>
                <a href="#picky-eating" className="text-primary hover:underline">
                  Picky Eating Solutions
                </a>
              </li>
              <li>
                <a href="#vitamins-supplements" className="text-primary hover:underline">
                  Vitamins & Supplements
                </a>
              </li>
              <li>
                <a href="#healthy-habits" className="text-primary hover:underline">
          ...
          >
            ...
            <p>
              Children's nutritional needs change dramatically as they grow. Understanding what they
              need at each stage helps you make confident feeding choices without stress.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              *Calories vary by size, activity level, and metabolism. Use as rough guide only.
            </p>

            <div className="rounded-2xl border border-border bg-muted p-5">
              <h3 className="font-semibold text-lg mb-2">The Division of Responsibility</h3>
              <p className="text-sm text-muted-foreground">
                <strong>Parent decides:</strong> What, when, and where to eat.
                <br />
                <strong>Child decides:</strong> Whether and how much to eat.
                <br />
                This evidence-based approach (Ellyn Satter) reduces mealtime battles and builds
                intuitive eating.
              </p>
            </div>
          </section>
          ...
          <section id="0-6-months" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Frequency:</strong> 8–12 times/24 hours (newborns); on demand
              </li>
              <li>
                <strong>Duration:</strong> 10–20 minutes per side; let baby set pace
              </li>
              <li>
            ...
            <p>
              Choose iron-fortified formula. No brand is "best"—all FDA-regulated formulas meet
          ...
          <section id="6-12-months" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Iron-fortified infant cereal</strong> (oat, barley, multigrain—not just
                rice)
              </li>
              <li>
                <strong>Pureed meats</strong> (chicken, beef, turkey)
              </li>
              <li>
                <strong>Beans & lentils</strong> (well-cooked, mashed)
              </li>
              <li>
                <strong>Dark leafy greens</strong> (spinach, kale—cooked and pureed)
              </li>
            </ul>

            <h3 className="text-xl font-semibold">Allergen Introduction</h3>
            <p>
              Early introduction (around 6 months, not before 4 months) of common allergens REDUCES
              allergy risk:
            </p>
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                <strong>Introduce one at a time, 2–3 days apart</strong> to identify reactions
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Purees:</strong> Easier to ensure iron intake; less mess
              </li>
              <li>
                <strong>BLW:</strong> Develops self-feeding, oral motor skills; baby controls pace
              </li>
              <li>
                <strong>Combo:</strong> Offer purees on preloaded spoons + finger foods on tray
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Honey</strong> (botulism risk)
              </li>
              <li>
                <strong>Cow's milk as main drink</strong> (yogurt/cheese OK)
              </li>
              <li>
                <strong>Choking hazards:</strong> whole grapes, nuts, popcorn, raw carrots, hot
                dogs, large chunks
              </li>
              <li>
                <strong>Added sugar & salt</strong>
              </li>
              <li>
                <strong>High-mercury fish</strong> (shark, swordfish, king mackerel)
              </li>
            </ul>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <a href="/articles/starting-solids-guide" className="text-primary hover:underline">
                Starting Solids: Complete Step-by-Step Guide
              </a>
            </p>
          </section>
          ...
          <section id="1-3-years" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Iron:</strong> Toddlers at highest risk for deficiency. Sources: meat,
                beans, fortified cereal, spinach + vitamin C
              </li>
              <li>
                <strong>Vitamin D:</strong> 600 IU/day (supplement often needed)
              </li>
              <li>
                <strong>Calcium:</strong> 700 mg/day (2–3 dairy servings or fortified alternatives)
              </li>
              <li>
                <strong>Fiber:</strong> Age + 5 g rule (2-year-old = 7g); prevents constipation
              </li>
              <li>
                <strong>Healthy fats:</strong> Brain development needs fat—avocado, nut butters,
                olive oil, full-fat dairy
              </li>
            </ul>
          </section>
          ...
          <section id="4-8-years" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Breakfast:</strong> Non-negotiable for learning and weight regulation
              </li>
              <li>
                <strong>Lunchbox strategy:</strong> Protein + fruit + veg + whole grain + fun food
              </li>
              <li>
                <strong>After-school snack:</strong> Bridge to dinner without ruining appetite
              </li>
              <li>
                <strong>Family meals:</strong> 3+ times/week linked to better nutrition, grades,
                mental health
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>Protein:</strong> 19–34 g/day for growth spurts
              </li>
              <li>
                <strong>Calcium & Vitamin D:</strong> Peak bone-building years (1,000 mg calcium,
                600 IU D)
              </li>
              <li>
                <strong>Iron:</strong> Especially girls approaching puberty
              </li>
              <li>
                <strong>Omega-3s:</strong> Brain development—fatty fish 2x/week or supplement
              </li>
            </ul>
          </section>
          ...
          <section id="picky-eating" className="space-y-6 text-sm leading-7 text-muted-foreground">
            ...
            <p>
              Picky eating is normal development (peaks 2–6 years). Most kids outgrow it with
            ...
            <ul className="list-disc space-y-3 pl-6">
              <li>
                <strong>Repeated exposure:</strong> 15–20 neutral exposures before acceptance. No
                pressure, just presence.
              </li>
              <li>
                <strong>Food chaining:</strong> Bridge from accepted foods to new ones (e.g.,
                chicken nugget → baked chicken strip → grilled chicken)
              </li>
              <li>
                <strong>Division of responsibility:</strong> You provide, they decide. No "one more
                bite," no dessert bribes.
              </li>
              <li>
                <strong>Involve them:</strong> Grocery shopping, washing veggies, stirring, setting
                table
              </li>
              <li>
                <strong>Serve family style:</strong> Let them serve themselves (builds autonomy)
              </li>
              <li>
                <strong>Pair new with familiar:</strong> Always include 1–2 safe foods on the plate
              </li>
              <li>
                <strong>Model eating:</strong> Eat the foods you want them to eat, with enjoyment
              </li>
              <li>
                <strong>Sensory play:</strong> Touch, smell, kiss, lick, bite—no expectation to
                swallow
              </li>
            </ul>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <strong>ARFID signs:</strong> Eating &lt;20 foods, entire food groups avoided,
                weight loss, nutritional deficiency
              </li>
              <li>
                <strong>Sensory issues:</strong> Gagging/vomiting with textures, extreme brand
                specificity
              </li>
              <li>
                <strong>Growth faltering:</strong> Falling off growth curve, low energy, frequent
                illness
              </li>
          ...
          >
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-border/50">
                    ...
                    <td className="p-3">
                      All breastfed infants; many formula-fed; all kids with limited sun
                    </td>
                  ...
                  <tr className="border-b border-border/50">
                    ...
                    <td className="p-3">
                      Exclusively breastfed 4+ mo; preterm; picky eaters; teen girls
                    </td>
                  ...
                  <tr className="border-b border-border/50">
                    ...
                    <td className="p-3">
                      Very restricted diets, medical conditions, failure to thrive
                    </td>
            ...
            <div className="rounded-2xl border border-border bg-muted p-5">
              ...
              <p className="text-sm text-muted-foreground">
                Look for <strong>USP Verified</strong>, <strong>NSF Certified</strong>, or{" "}
                <strong>ConsumerLab</strong> seals. Gummies often lack iron and have sugar.
                Chewables or liquids absorb better.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                Juice: &lt;4 oz/day (1–3 yr), &lt;6 oz/day (4–6 yr), &lt;8 oz/day (7+); whole fruit
                better
              </li>
            ...
            <dl className="space-y-6">
              <div>
                <dt className="font-semibold text-foreground">
                  My toddler only wants to eat [one food]. Is this okay?
                </dt>
                <dd className="mt-2">
                  Food jags are normal. Keep offering variety without pressure. They'll usually
                  expand again in weeks. If it lasts months or they drop foods, consult your
                  pediatrician.
                </dd>
              </div>
              <div>
                ...
                <dd className="mt-2">
                  "Hiding" works short-term but doesn't teach acceptance. Better: add veggies openly
                  (spinach in smoothies, zucchini in muffins) AND serve visible veggies. Both
                  approaches together.
                </dd>
              </div>
              <div>
                ...
                <dd className="mt-2">
                  Soy milk (fortified, unsweetened) is the only plant milk nutritionally comparable
                  to cow's milk for toddlers. Almond, oat, rice milks lack protein/fat. Consult
                  pediatrician if dairy-free.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                ...
                <dd className="mt-2">
                  Roughly 0.5g per pound of body weight. A 30 lb toddler needs ~15g—easily met with
                  1 egg + ½ cup yogurt + 1 oz chicken. Most kids get plenty.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                  My child won't drink water. What do I do?
                </dt>
                <dd className="mt-2">
                  Make it fun: special cup, straw, ice shapes, fruit infusions. Offer water-rich
                  foods (watermelon, cucumber, soup). Limit milk to 16–24 oz so they're thirsty for
                  water.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                  Are organic foods worth it for kids?
                </dt>
                <dd className="mt-2">
                  Organic reduces pesticide exposure. If budget allows, prioritize the "Dirty Dozen"
                  (strawberries, spinach, apples, etc.). But conventional fruits/veggies are far
                  better than none. Wash all produce well.
                </dd>
              </div>
              <div>
                <dt className="font-semibold text-foreground">
                ...
                <dd className="mt-2">
                  Focus on growth trends (following their curve), not percentiles. Sudden jumps or
                  drops, or crossing 2+ percentile lines, warrant discussion with pediatrician.
          ...
          <div className="rounded-2xl border border-border bg-muted p-6 pt-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <a href="/articles/toddler-nutrition-tips" className="text-primary hover:underline">
                Toddler Nutrition Tips
              </a>
              <span className="text-muted-foreground">•</span>
              <a href="/articles/best-baby-formula" className="text-primary hover:underline">
                Best Baby Formula
              </a>
              <span className="text-muted-foreground">•</span>
              <a href="/articles/best-baby-bottles" className="text-primary hover:underline">
                Best Baby Bottles
              </a>
              <span className="text-muted-foreground">•</span>
              <a href="/articles/best-baby-food-makers" className="text-primary hover:underline">
          ...
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              does not constitute medical advice. Always consult your pediatrician or pediatric
              dietitian for your child's specific nutritional needs.
            </p>
          </div>
        </article>
      </main>
