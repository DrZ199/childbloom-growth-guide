    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <article className="space-y-8 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
        ...
        <div className="space-y-6 text-sm leading-7 text-muted-foreground">
          <p>
            Newborn sleep is unpredictable, but a simple routine and safe sleep setup can help your
            family rest better.
          </p>
          <h2 className="text-2xl font-semibold">Safe sleep basics</h2>
          <p>
            Room-sharing is recommended, but never bed-sharing. Place baby on their back on a firm,
            uncluttered surface and keep the room at a comfortable temperature.
          </p>
