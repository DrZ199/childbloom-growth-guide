...
export const Route = createFileRoute("/articles/speech-milestones")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track your toddler's speech milestones and learn when to seek support." },
    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <article className="space-y-8 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
        <div className="space-y-3">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-primary">Development</p>
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">Speech Milestones from 12 to 24 Months (and When to Ask for Help)</h1>
          <p className="text-sm text-muted-foreground">7 min read • Published May 18, 2026</p>
        </div>
        <div className="space-y-6 text-sm leading-7 text-muted-foreground">
          <p>Every toddler grows language differently. These milestones show what is typical at each stage.</p>
          ...
          <p>Talk through daily routines, repeat words clearly, and read books together every day to give your toddler the strongest start.</p>
        </div>
      </article>
    </main>
  );
