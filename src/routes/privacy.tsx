    ...
    <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      <article className="space-y-8 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
        ...
        <section className="space-y-4 text-sm leading-7 text-muted-foreground">
          <p>
            ChildBloom collects email addresses only for newsletter subscription and communication.
            We never sell your personal data.
          </p>
          <p>
            Cookies are used to improve site performance and to remember your preferences. You may
            manage cookies through your browser.
          </p>
          <p>
            Third-party services may collect analytics data. We use that information to improve the
